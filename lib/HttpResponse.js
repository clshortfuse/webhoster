...
export default class HttpResponse {
  ...
  constructor(options) {
    ...
    this.rawStream = options.rawStream || options.payload;
    this.payload = options.payload || options.rawStream;
