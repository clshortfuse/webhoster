...
/** @typedef {'end'|'break'|'continue'|null|undefined} MiddlewareResultValue */

/** @typedef {Promise<MiddlewareResultValue>|MiddlewareResultValue|void} MiddlewareResult */
/** @typedef {import('./index').Middleware} Middleware */
...
export function handleRequest(req, res) {
   ...
   * @return {Promise<MiddlewareResultValue|void>}
   */
  function handleMiddleware(middleware) {
    ...
    if (Symbol.iterator in middleware) {
      ...
      /**
       * @param {MiddlewareResultValue} [chainResult]
       * @return {Promise<MiddlewareResultValue|void>}
       */
